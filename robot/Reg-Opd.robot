...
4. INSERT FORM REG
   #ช่องทางให้ข้อมูล
   Wait Until Element Is Visible  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div.ui.form > div > div.field.seven.wide.required > div > i  timeout=20
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div.ui.form > div > div.field.seven.wide.required > div > i
   Wait Until Element Is Visible  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div.ui.form > div > div.field.seven.wide.required > div > div.menu.transition.visible > div:nth-child(2)  timeout=20
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div.ui.form > div > div.field.seven.wide.required > div > div.menu.transition.visible > div:nth-child(2)
   #หมายเลขบัตรประจำตัวประชาชน
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(5) > div:nth-child(3) > div > input[type=text]
   Input Text  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(5) > div:nth-child(3) > div > input[type=text]  ${Identification_number}
   #ชื่อ-นามสกุล
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(6) > div.field.three.wide.required > div > input.search
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(6) > div.field.three.wide.required > div > div.menu.transition.visible > div:nth-child(2)
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(6) > div:nth-child(3) > div > input[type=text]
   Input Text  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(6) > div:nth-child(3) > div > input[type=text]  ${first_name_th}
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(6) > div:nth-child(4) > div > input[type=text]
   Input Text  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(6) > div:nth-child(4) > div > input[type=text]  ${last_name_th}
   #เพศ
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(8) > div.field.three.wide.required > div > input.search
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(8) > div.field.three.wide.required > div > div.menu.transition.visible > div.item.selected
   #หมู่เลือด
   Click Element  xpath:/html/body/div[26]/div[2]/div[2]/div[2]/div/div[2]/div/div[1]/div/div[2]/div/div/div[3]/div[8]/div[3]/div
   Click Element  xpath:/html/body/div[26]/div[2]/div[2]/div[2]/div/div[2]/div/div[1]/div/div[2]/div/div/div[3]/div[8]/div[3]/div/div[2]/div[1]
   #วันเกิด
   Input Text  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(9) > div:nth-child(2) > div > input  ${birthdate}
   #สัญชาติ
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(10) > div.field.five.wide.required > div > input.search
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(10) > div.field.five.wide.required > div > div.menu.transition.visible > div.item.selected
   #ชื่อบิดา-มารดา
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(14) > div:nth-child(1) > div > input[type=text]
   Input Text  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(14) > div:nth-child(1) > div > input[type=text]  ${father}
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(14) > div:nth-child(2) > div > input[type=text]
   Input Text  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div:nth-child(14) > div:nth-child(2) > div > input[type=text]  ${mother}
   # บันทึกข้อมูลผู้ป่วย
   ...
   Set Focus To Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(1) > div.ui.column.thirteen.wide > div > div > div:nth-child(1) > div.field.six.wide > div > input[type=text]
   ${HN} =   Get Value    css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(1) > div.ui.column.thirteen.wide > div > div > div:nth-child(1) > div.field.six.wide > div > input[type=text]
...
20. Progression / order
   ...
   #Save Order
   Sleep  15s
   Wait Until Element Is Visible  css:body > div:nth-child(141) > div > div > div > div.content.active > div.ui.container.fluid > div.ui.segment > div > div > div.field.four.wide > button.ui.button.icon.green  timeout=30
