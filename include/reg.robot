...
ช่องทางให้ข้อมูล
   ...
   Wait Until Element Is Visible  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(3) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div.ui.form > div > div.field.seven.wide.required > div > div.menu.transition.visible > div.item.selected  timeout=20
   Click Element  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.layout-horizontal > div.ui.middle > div > div:nth-child(3) > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div.ui.form.success > div.ui.form > div > div.field.seven.wide.required > div > div.menu.transition.visible > div.item.selected
...
บันทึกข้อมูลผู้ป่วย
   Click Button  css:body > div.ui.container.fluid > div.ui.layout-vertical > div.ui.north > div > div.ui.container.fluid > div > div:nth-child(4) > button
